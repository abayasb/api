...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/material-design-lite/1.3.0/material.min.js.map"></script>
				...
				<ul class="full-width list-unstyle menu-principal">
					...
					<li class="full-width">
						...
						<ul class="full-width menu-principal sub-menu-options">
							...
							<li class="full-width">
								<a href="tipo.html" class="full-width">
									<div class="navLateral-body-cl">
							...
							<li class="full-width">
								<a href="marca.html" class="full-width">
									<div class="navLateral-body-cl">
										<i class="zmdi zmdi-label"></i>
									</div>
									<div class="navLateral-body-cr hide-on-tablet">
